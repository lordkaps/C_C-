...
DATE =  30/11/2021
Proposta = MODULO DE CADASTRO DE DADOS, BUSCA E ATAULIZACAO.
*/
...
void abertura()
{
    printf("\n\n");
    printf("|**************************************|\n");
    printf("|     Bem vindo ao Modulo Cadastro!    |\n");
    printf("|                                      |\n");
    printf("| Utilize somente letras maiusculas    |\n");
    printf("|   para a busca e o cadastro.         |\n");
...
void tabela(int linha, int linhas)
{
    ...
    printf("|                NOME||            ENDERECO||                 CEP||              BAIRRO||            TELEFONE|\n");
    printf("|------------------------------------------------------------------------------------------------------------|\n");
